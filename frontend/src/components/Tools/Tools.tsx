...
interface ToolsProps {
  activeTab: 'todo' | 'backlog' | 'terminal' | 'approval' | 'code-interpreter' | 'file-browser';
  setActiveTab: (tab: 'todo' | 'backlog' | 'terminal' | 'approval' | 'code-interpreter' | 'file-browser') => void;
