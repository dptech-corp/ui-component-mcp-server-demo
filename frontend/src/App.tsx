...
function AppContent() {
  const [activeTab, setActiveTab] = useState<'todo' | 'backlog' | 'terminal' | 'approval' | 'code-interpreter' | 'file-browser'>('todo');
      ...
      switch (lastEvent.event) {
        case 'component_switch':
          if (lastEvent.data.component) {
            setActiveTab(lastEvent.data.component as 'todo' | 'backlog' | 'terminal' | 'approval' | 'code-interpreter' | 'file-browser');
          }
          break;
